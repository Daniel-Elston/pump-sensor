...
def create_df(sensor_n, dataset, prepared_data, anomalies, scores):
    """
...
def get_visuals(sensor_n, df):
    ...
    plt.scatter(
        get_anomaly.index,
        get_anomaly[[f'sensor_{sensor_n}']],
        color='red',
        label='anomaly',
        s=10
    )
...
def apply_level_shifts(alarms, shift_type):
    """
